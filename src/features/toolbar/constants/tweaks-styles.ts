export const TWEAKS_STYLE = `
  .twk-panel{position:fixed;right:16px;bottom:16px;z-index:2147483646;width:280px;
    ...
    background:rgba(22,25,29,.78);color:#e7e9ec;
  ...
  .twk-x:hover{background:rgba(255,255,255,.06);color:#e7e9ec}
  ...
  .twk-field{appearance:none;width:100%;height:26px;padding:0 8px;
    border:.5px solid rgba(255,255,255,.1);border-radius:7px;
    background:rgba(255,255,255,.04);color:inherit;font:inherit;outline:none}
  .twk-field:focus{border-color:rgba(255,255,255,.3);background:rgba(255,255,255,.08)}
  ...
  .twk-slider::-webkit-slider-thumb{-webkit-appearance:none;appearance:none;
    ...
    border:.5px solid rgba(0,0,0,.12);box-shadow:0 1px 3px rgba(0,0,0,.5);cursor:pointer}
  ...
  .twk-toggle i{position:absolute;top:2px;left:2px;width:14px;height:14px;border-radius:50%;
    background:#fff;box-shadow:0 1px 2px rgba(0,0,0,.5);transition:transform .15s}
  .twk-toggle[data-on="1"] i{transform:translateX(14px)}
  .twk-swatch{appearance:none;-webkit-appearance:none;width:56px;height:22px;
    border:.5px solid rgba(255,255,255,.1);border-radius:6px;padding:0;cursor:pointer;
  ...
  .twk-chip{position:relative;appearance:none;flex:1;min-width:0;height:46px;
    ...
    box-shadow:0 0 0 .5px rgba(255,255,255,.12),0 1px 2px rgba(0,0,0,.3);
    transition:transform .12s cubic-bezier(.3,.7,.4,1),box-shadow .12s}
  .twk-chip:hover{transform:translateY(-1px);
    box-shadow:0 0 0 .5px rgba(255,255,255,.25),0 4px 10px rgba(0,0,0,.4)}
  .twk-chip[data-on="1"]{box-shadow:0 0 0 1.5px rgba(255,255,255,.85),
